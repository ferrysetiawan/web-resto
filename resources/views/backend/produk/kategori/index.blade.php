                ...
                <table class="table dt-responsive nowrap w-100" id="basic-datatable">
                    ...
                    <tbody>
                        @foreach ($categories as $no=>$item)
                            <tr>
                                <td>{{ $no + 1 }}</td>
                                <td><img src="{{ asset($item->gambar) }}" style="display: block;height:auto;width:100%" alt=""></td>
...
<script>
    $(document).ready(function () {
        $('.dataTables_filter input').after('<a href="{{ route('categoryProduct.create') }}" class="btn btn-info ms-2">Create</a>')
    });
