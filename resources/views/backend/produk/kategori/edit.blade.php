                ...
                <form autocomplete="off" action="{{ route('categoryProduct.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input id="input_post_thumbnail" name="gambar" value="{{ old('gambar') ? old('gambar') : asset($category->gambar) }}" type="text" class="form-control {{$errors->first('gambar') ? "is-invalid": ""}}" placeholder="" readonly />
                            <div class="invalid-feedback">
                                {{$errors->first('gambar')}}
                            </div>
                        </div>
